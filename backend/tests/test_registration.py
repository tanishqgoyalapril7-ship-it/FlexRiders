...
def test_registration_stores_normalised_vehicle_number(client):
    body = {"full_name": "Plate Rider", "mobile_number": "9100000123", "password": "riderPass1", "vehicle_number": "hr 26 dk 8337"}
    ...
    bad = client.post(f"{API}/auth/register", json={**body, "mobile_number": "9100000124", "vehicle_number": "12345"})
    assert bad.status_code == 422
    dup = client.post(f"{API}/auth/register", json={**body, "mobile_number": "9100000125", "vehicle_number": "HR-26-DK-8337"})
