...
def test_empty_database_to_campaign(empty_client):
    ...
    reg = c.post(f"{API}/auth/register", json={"selfie": SELFIE, "vehicle_category": "CYCLE", "accept_terms": True, "full_name": "Rahul Sharma", "mobile_number": "9876500001", "password": "riderPass1", "primary_city": "Gurugram"}).json()
